...
<?php else : ?>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<p> آیا شما کاربر <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> نیستید؟ <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="خروج از حساب کاربری"> خارج شوید &raquo;</a></p>

<?php else : ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="author">نام <?php if ($req) echo "(الزامی)"; ?> :</label>
                            <input type="text" name="author" id="author" class="textarea"
                                   value="<?php echo $comment_author; ?>" size="28" tabindex="1"/>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="email">پست‌الکترونیک <?php if ($req) echo "(الزامی)"; ?> :</label>
...
<?php endif; ?>
		...
		<div class="col-md-12">
			...
			<input name="submit" id="submit" type="submit" tabindex="5" value="ارسال دیدگاه"/><?php comment_id_fields(); ?>
		</div>
