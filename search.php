                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb clearfix" itemscope itemtype="https://schema.org/BreadcrumbList">
                            ...
                            <li class="breadcrumb-item active" aria-current="page" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <span itemprop="name"> نتایج جستجوی شما برای عبارت "<?php echo get_search_query(); ?>"</span>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="center">
                                            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/not-found.gif" class="img-fluid"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="not-found my-lg-5">
                                            <h1 class="text-center">یافت نشد!</h1>
                                            <h2 class="text-center">متأسفانه جستجوی شما نتیجه ای در بر نداشت.</h2>
                                            <h3 class="text-right mt-5">لطفاً دوباره تلاش کنید</h3>
